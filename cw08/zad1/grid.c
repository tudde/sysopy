...
void* thread_routine(void* args){
    ...
    while(1){
        arg->dst[arg->i] = is_alive(arg->i/grid_width, arg->i%grid_width, arg->src);
        //printf("oh look a %d thread\n", arg->i);
        char* tmp;
        tmp = arg->src;
        arg->src = arg->dst;
        arg->dst = tmp;
...
void threads_init(pthread_t threads[], thread_args** arg_structs, int n, char* src, char* dst){
